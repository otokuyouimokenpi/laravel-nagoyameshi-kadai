...
class SubscriptionTest extends TestCase
{
    ...
    public function test_paid_user_cannot_store_subscription()
    {
        $user = User::factory()->create();
    ...
    public function test_admin_cannot_access_subscription_()
    {
        // 既存の admin@example.com を削除
        Admin::where('email', 'admin@example.com')->delete();
    ...
    public function test_free_user_cannot_update_subscription()
    {
        $user = User::factory()->create();
    ...
    public function test_paid_user_cannot_update_subscription()
    {
        $user = User::factory()->create();
    ...
    public function test_admin_cannot_update_subscription_()
    {
        // 既存の admin@example.com を削除
        Admin::where('email', 'admin@example.com')->delete();
    ...
    public function test_guest_user_cannot_access_subscription_cancel()
    {
    ...
    public function test_paid_user_cannot_access_subscription_cancel()
    {
        // 既存の admin@example.com を削除
        Admin::where('email', 'admin@example.com')->delete();
    ...
    public function test_free_user_cannot_destroy_subscription()
    {
        $user = User::factory()->create();
